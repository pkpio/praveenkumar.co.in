...
class S2_Counter_widget extends WP_Widget {
	...
	*/
	function S2_Counter_widget() {
		$widget_options = array('classname' => 's2_counter', 'description' => __('Subscriber Counter widget for the Follow plugin', 'subscribe2') );
		$control_options = array('width' => 250, 'height' => 500);
		$this->WP_Widget('s2_counter', __('Subscriber Counter', 'subscribe2'), $widget_options, $control_options);
	}
