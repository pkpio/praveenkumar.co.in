...
<body>
<table><tr>
<td class=<?php if(1){echo 'table';} else { echo 'tableclick' ;}?> onmousedown="chcol(this)" onMouseOut="retcol(this)">Wow !</td>
<td class=<?php if(1){echo 'table2';} else { echo 'table2 click' ;}?> id="number"><a>01</a></td>
</tr></table>
</body>
</html>
